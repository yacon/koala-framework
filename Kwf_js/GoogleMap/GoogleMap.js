...
Kwf.GoogleMap.load = function(callback, scope)
{
    ...
    var url = 'http:/'+'/maps.googleapis.com/maps/api/js?libraries=places&v=3.exp&sensor=false&key={Kwf_Assets_GoogleMapsApiKey::getKey()}&c&async=2&language='+trlKwf('en');
